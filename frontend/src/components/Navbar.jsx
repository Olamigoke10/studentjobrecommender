...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="sticky top-0 z-50 bg-white/70 backdrop-blur-xl border-b border-white/70 shadow-soft dark:bg-slate-950/70 dark:border-slate-800/80 print:hidden">
